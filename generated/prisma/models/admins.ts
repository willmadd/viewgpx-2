...
export type adminsWhereInput = {
  ...
  user_id?: Prisma.UuidFilter<"admins"> | string
...
export type adminsScalarWhereWithAggregatesInput = {
  ...
  user_id?: Prisma.UuidWithAggregatesFilter<"admins"> | string
...
export type adminsOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"user_id" | "created_at", ExtArgs["result"]["admins"]>
...
export interface adminsDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const adminsWithUser_idOnly = await prisma.admins.findMany({ select: { user_id: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many Admins and only return the `user_id`
   * const adminsWithUser_idOnly = await prisma.admins.createManyAndReturn({
   *   select: { user_id: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more Admins and only return the `user_id`
   * const adminsWithUser_idOnly = await prisma.admins.updateManyAndReturn({
   *   select: { user_id: true },
   *   where: {
   *     // ... provide filter here
   *   },
